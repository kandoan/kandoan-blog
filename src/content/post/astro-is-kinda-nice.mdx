...
description: 'Here are my opinion on Astro the frontend web framework after using it to make this blog.'
pubDate: '2024-02-29'
...
## What is `Astro`?
Astro is one of the new trendy frontend web framework in the recent years. 
...
Believe it or not, I wasn't planning on starting with Astro at first. There are so many options to start one's own blog nowaday: 
...
I would burn out super fast if my life keep on being like that. I gotta keep myself in check or I may start hating it.

So, naturally, I started out with an easier option. I went with *Wordpress* the CMS. It was quite simple to set it up and running.
...
I have no interest in *PHP* or anything related to it. It was much more of an annoyance than fun.

So then I went seeking for an alternative. And I went down a step from CMS, I went for an SSG. And I picked Astro:
...
It supported so many things outside of the box, especially for blogging purpose. There is very little need for reinventing the wheel because of that.
...
Not everything nowaday has to be another generic multi-purpose framework to replace React.
